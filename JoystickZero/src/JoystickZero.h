/*
  JoystickZero.h (Arduino Zero Version of Joystick.h)

  Original Copyright (c) 2015, Matthew Heironimus
  Changes to work with Arduino Zero Copyright (c) 2020, Terry MacDonald
...
#if ARDUINO < 10606
  #error The JoystickZero library requires Arduino IDE 1.6.6 or greater. Please update your IDE.
#endif
